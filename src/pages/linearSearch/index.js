...
function Index() {
    ...
    const {searching, generateNewArray, toFind, index, search, handleLength, array, returnBarForNum} = Logic()
    ...
    <div className="linear">
      ...
      <div className="options">
        ...
        <div>
            ...
            <small>Change the number you want to search for by clicking on a bar</small>
        </div>
      ...
      <div className="bars">
        {
            array?.length > 0 && array?.map((ele, idx) => returnBarForNum(ele, idx))
